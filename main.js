...
(() => {
  ...
  const STORAGE = {
    ...
    mainTopic: "flash.ar-en.mainTopic.v1",
  };
  ...
  /** Preserves insertion order while de-duplicating on Arabic spelling. */
  ...
  /** Add the visible card into the saved-memory list (Arabic key stays unique). */
  ...
  /** Flip Arabic ↔ English. Never advances the card. */
  ...
  /** → / mobile Next: first press shows English; second press loads next card (Arabic up). */
